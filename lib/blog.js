...
/** Primary URLs for SEO keyword clusters (cannibalization control) */
export const SEO_PRIMARY_PR_FORMS_URL =
  'https://newcollab.co/blog/ultimate-2026-directory-brands-with-open-pr-application-forms';
export const SEO_PRIMARY_PR_FORMS_LIST_URL =
  'https://newcollab.co/blog/pr-list-for-clothing-brands-micro-influencers-2025';

export function getPostCanonicalUrl(post) {
  if (!post) return null;
  return post.canonicalUrl || `https://newcollab.co/blog/${post.slug}`;
}
