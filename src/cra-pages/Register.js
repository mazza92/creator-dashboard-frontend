  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Create your Newcollab account in seconds. Start receiving brand bids and unlock your creator dashboard." />
        <link rel="canonical" href="https://newcollab.co/register" />
        <meta property="og:title" content="Sign Up | Newcollab" />
        <meta property="og:description" content="Create your Newcollab account in seconds. Start receiving brand bids and unlock your creator dashboard." />
        <meta property="og:url" content="https://newcollab.co/register" />
      ...
      <GradientBg>
        ...
        <Container>
          <Card as="form" onSubmit={handleSubmit} autoComplete="off">
            <Title>Join Newcollab <span style={{ background: 'none', WebkitBackgroundClip: 'initial', WebkitTextFillColor: 'initial', backgroundClip: 'initial' }}>🚀</span></Title>
            <Subheading>Create your account and start your creator journey</Subheading>
            <div>
