...
export default function Register() {
  ...
  // Google SSO handler (placeholder - requires setup)
  const handleGoogleSSO = () => {
    // Google SSO would be implemented here with google-auth library
    // For now, just show that it's not configured
    ...
    <>
      ...
      <PageWrapper>
        ...
        <Card as="form" onSubmit={handleSubmit}>
          ...
          <GoogleBtn type="button" onClick={handleGoogleSSO}>
