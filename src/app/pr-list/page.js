...
export const metadata = {
  title: 'PR List 2026: 2,000+ Brands Accepting Influencer Applications | Newcollab',
  description:
    'The ultimate PR list for influencers — 2,000+ brands accepting PR applications in 2026. Find beauty, skincare, K-beauty & fashion brands with micro-influencer friendly programs. Free to browse.',
  keywords:
  ...
  openGraph: {
    title: 'PR List 2026: 2,000+ Brands Accepting Applications',
    description:
      'Browse the ultimate PR list — 2,000+ brands accepting influencer applications. Beauty, skincare, K-beauty & fashion. Micro-influencer friendly.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'PR List for Influencers — 2,000+ Brands',
    description:
...
export default async function PrListPage() {
  ...
  return (
    <>
      <h1 style={srOnly}>PR List 2026: 2,000+ Brands Accepting Influencer Applications</h1>
