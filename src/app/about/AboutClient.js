...
const RoadmapLabel = styled.div`
  ...
  margin-bottom: 4px;
  color: ${(p) =>
    p.$status === 'now' ? colors.rose : colors.text3};
`;
    ...
    <LandingPageLayoutNext>
      <Page>
        ...
        <Hero>
          ...
          <HeroCta>
            <BtnBlack href="/register/creator" style={{ padding: '15px 28px', fontSize: 16, borderRadius: 14 }}>
              Try it free →
            </BtnBlack>
        ...
        <FinalCta>
          <ContainerSm>
            ...
            <FinalCtaActions>
              <BtnRose href="/register/creator" style={{ padding: '15px 28px', fontSize: 16, borderRadius: 14 }}>
