...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'Sign up for newcollab, browse the brand directory filtered to your niche, and send an AI-generated pitch with your auto-attached media kit or a free UGC portfolio from https://newcollab.co/media-kit. Most creators land their first deal within 2 weeks — the key is sending enough pitches and following up. The free plan gives you 3 pitches a month to start.',
  },
  {
    question: 'Do I need a media kit to pitch brands?',
    answer:
      "Yes — it's the #1 reason brands ignore cold emails. Publish a free UGC portfolio in minutes at https://newcollab.co/media-kit (no Canva, no account) and paste that link in your pitch, Instagram bio, and TikTok description. Signed-in creators also get an auto-generated media kit attached to every pitch.",
  },
  {
