...
import { useAnalytics } from './components/AnalyticsProviderNext';
...
// Create a motion-compatible Link wrapper for Next.js
...
// Use a wrapper approach for better Next.js Link compatibility
...
const ViewAllButtonLink = styled(Link)`
  display: inline-flex;
  align-items: center;
...
const Founding50 = () => {
  ...
  const handleClaim = async (e) => {
    ...
    router.push(`/register/creator?username=${encodeURIComponent(cleanUsername)}`);
  };
  ...
  return (
    <LandingPageLayoutNext canonicalUrl="https://newcollab.co/">
      ...
      {/* Metadata is handled in page.js via Next.js metadata API */}
      <GlobalStyle />
      <PageWrapper>
        <ContentContainer>
           ...
           <Section id="how-it-works">
            ...
            <section aria-labelledby="content-formats-heading">
              <ContentFormatsSection>
                ...
                <ContentFormatsText>
                  <ContentFormatsTitle id="content-formats-heading">
                  ...
                  <ContentFormatsDescription>
                    ...
                    <ContentFormatsButton onClick={() => router.push('/register')}>
              ...
              <BenefitsSection>
                <BenefitsContainer>
                  ...
                  <BenefitsColumn>
                    ...
                    <BenefitsTitle id="benefits-heading">
            ...
            <FaqContainer>
              ...
              <div style={{
                ...
                <p style={{ 
                  ...
                  Glossier, Fabletics, and more bid on your ad slots. <Link href="/brands/pr-packages" style={{ color: 'white', textDecoration: 'underline', fontWeight: '600' }}>Brands can send PR packages here</Link>.
                </p>
              </div>
